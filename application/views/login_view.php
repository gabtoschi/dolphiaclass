...
<html lang="en">
	...
	<body>
        ...
        <div align="center"><img src="<?php echo base_url('images/login_header.png'); ?>"/></div>
        <div align="center">
        <?php
        ...
        echo '</p>';
        echo form_submit(array('name' => 'enter', 'id' => 'entrar'), 'ENTRAR');
        echo '<br><br>';
        echo form_hidden('isMobile', '0');
        echo form_close();
        ?>
        </div>
        <?php
        echo anchor('login/swapMobile/1', '<p align="center">Entrar na versão mobile</p>');
